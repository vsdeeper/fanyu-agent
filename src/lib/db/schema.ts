...
export const imageTextTasks = sqliteTable('image_text_tasks', {
  id: text('id').primaryKey(),
  name: text('name').notNull(),
  workflowVersion: integer('workflow_version').notNull(),
  createdAt: text('created_at').notNull(),
...
export const imageTextTaskSteps = sqliteTable(
  'image_text_task_steps',
  {
    taskId: text('task_id')
      .notNull()
      .references(() => imageTextTasks.id, { onDelete: 'cascade' }),
    stepKey: text('step_key').notNull(),
    snapshotVersion: integer('snapshot_version').notNull(),
    data: text('data').notNull(),
    createdAt: text('created_at').notNull(),
...
export const imageTextTaskAssets = sqliteTable('image_text_task_assets', {
  id: text('id').primaryKey(),
  taskId: text('task_id')
    .notNull()
    .references(() => imageTextTasks.id, { onDelete: 'cascade' }),
...
export const novelTasks = sqliteTable('novel_tasks', {
  id: text('id').primaryKey(),
  name: text('name').notNull(),
  workflowVersion: integer('workflow_version').notNull(),
  createdAt: text('created_at').notNull(),
...
export const novelTaskSteps = sqliteTable(
  'novel_task_steps',
  {
    taskId: text('task_id')
      .notNull()
      .references(() => novelTasks.id, { onDelete: 'cascade' }),
    stepKey: text('step_key').notNull(),
    snapshotVersion: integer('snapshot_version').notNull(),
    data: text('data').notNull(),
    createdAt: text('created_at').notNull(),
...
export const novelTaskAssets = sqliteTable('novel_task_assets', {
  id: text('id').primaryKey(),
  taskId: text('task_id')
    .notNull()
    .references(() => novelTasks.id, { onDelete: 'cascade' }),
...
export const longArticleTasks = sqliteTable('long_article_tasks', {
  id: text('id').primaryKey(),
  name: text('name').notNull(),
  workflowVersion: integer('workflow_version').notNull(),
  createdAt: text('created_at').notNull(),
...
export const longArticleTaskSteps = sqliteTable(
  'long_article_task_steps',
  {
    taskId: text('task_id')
      .notNull()
      .references(() => longArticleTasks.id, { onDelete: 'cascade' }),
    stepKey: text('step_key').notNull(),
    snapshotVersion: integer('snapshot_version').notNull(),
    data: text('data').notNull(),
    createdAt: text('created_at').notNull(),
...
export const longArticleTaskAssets = sqliteTable('long_article_task_assets', {
  id: text('id').primaryKey(),
  taskId: text('task_id')
    .notNull()
    .references(() => longArticleTasks.id, { onDelete: 'cascade' }),
...
export const studioJobs = sqliteTable(
  ...
  {
    id: text('id').primaryKey(),
    /** 与资产磁盘段一致：ecommerce / product-model / product-retouch / business-analysis / wechat-article / image-text / novel / long-article */
