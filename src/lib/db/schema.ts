...
export const styleTuningTasks = sqliteTable('style_tuning_tasks', {
  id: text('id').primaryKey(),
  name: text('name').notNull(),
  workflowVersion: integer('workflow_version').notNull(),
  createdAt: text('created_at').notNull(),
...
export const styleTuningTaskSteps = sqliteTable(
  'style_tuning_task_steps',
  {
    taskId: text('task_id')
      .notNull()
      .references(() => styleTuningTasks.id, { onDelete: 'cascade' }),
    stepKey: text('step_key').notNull(),
    snapshotVersion: integer('snapshot_version').notNull(),
    data: text('data').notNull(),
    createdAt: text('created_at').notNull(),
...
export const styleTuningTaskAssets = sqliteTable('style_tuning_task_assets', {
  id: text('id').primaryKey(),
  taskId: text('task_id')
    .notNull()
    .references(() => styleTuningTasks.id, { onDelete: 'cascade' }),
