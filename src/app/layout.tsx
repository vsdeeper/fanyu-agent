      ...
      <head>
        ...
        <script
          dangerouslySetInnerHTML={{
            __html: `(function(){try{var m=localStorage.getItem('fanyu-theme');if(m!=='light'&&m!=='dark'&&m!=='system'){m='system';}if(m==='system'){m=(window.matchMedia&&matchMedia('(prefers-color-scheme: dark)').matches)?'dark':'light';}var d=document.documentElement;d.dataset.theme=m;d.style.colorScheme=m;}catch(e){}})();`,
          }}
        />
      </head>
      <body>
