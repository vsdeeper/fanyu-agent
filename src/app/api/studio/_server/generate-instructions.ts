...
/**
 * 电商主图出站 prompt：商业分析定整套气质，本张拍摄场景定空间，本张文案定信息；精修图为产品事实。
 */
export function buildMainImagePrompt(requirement: string, analysisText: string): string {
  return [
    ...
    '根据【商业分析】确定整套配色、光影气质、材质、品牌氛围与文案字体/配色；本张空间、道具与构图切片以【本张文案】中的拍摄场景为准。',
    '本张出现的文案只来自【本张文案】里的主标题与辅点，禁止把拍摄场景说明写进画面文字。',
    '禁止把空洞白底棚拍或同一套通用生活方式模板当作所有主题的默认背景；套图之间构图与场景须按各自拍摄场景区分。',
    '【商业分析】',
    analysisText.trim(),
    '【本张文案】',
    requirement.trim(),
