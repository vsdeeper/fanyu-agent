...
/** 主图专用文字排版：画面只放本张短文案，字体与配色跟套图规范走。 */
export const MAIN_IMAGE_COPY_TYPOGRAPHY_PROMPT =
  '文字编排：画面文案须简洁、清晰、易读，只采用本张【本张文案】，不要扩写、不要加解释。一句主标题，辅点不超过该主题 brief 里的同簇条目（核心卖点最多 2 条辅点，功能特点最多 2 条细节）。禁止把其它主题卖点做成完整图标/要点栏，禁止把 3～5 条卖点平铺回画面。字体家族、文案配色必须整套遵守【套图视觉规范】：主标题与辅点只允许字号/字重差，禁止一张衬线一张无衬线，禁止各张自选字色。主标题与辅点字号足够大、占比适中、间距分明；文字占画面比例适中、与产品主体平衡、不遮挡产品。文字禁投影、描边、发光等特效，与场景自然融合，勿用与背景割裂的实心色块或底板。构图、光影、场景与道具以【套图视觉规范】为准，不要把空洞白底棚拍或同一套通用生活方式模板当作所有主题的默认背景。';
