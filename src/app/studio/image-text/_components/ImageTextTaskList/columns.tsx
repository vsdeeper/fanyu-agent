...
import type { ImageTextTaskListItem } from '@/app/api/studio/image-text/_shared/task-types';
...
export function createTaskColumns({
  ...
  onMaterial: (task: ImageTextTaskListItem) => void;
  onDelete: (task: ImageTextTaskListItem) => Promise<void>;
}): TableColumnsType<ImageTextTaskListItem> {
  return [
    {
      title: '任务名称',
      dataIndex: 'name',
