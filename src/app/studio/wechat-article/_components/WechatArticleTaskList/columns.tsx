...
import type { WechatArticleTaskListItem } from '@/app/api/studio/wechat-article/_shared/task-types';
...
export function createTaskColumns({
  ...
  onMaterial: (task: WechatArticleTaskListItem) => void;
  onDelete: (task: WechatArticleTaskListItem) => Promise<void>;
}): TableColumnsType<WechatArticleTaskListItem> {
  return [
    {
      title: '任务名称',
      dataIndex: 'name',
