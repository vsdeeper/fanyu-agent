...
export const REFINE_SELECT_MISSING = '请先点选至少一张精修图作为精修标准';
export const REFINE_SELECT_MAX = '最多选择 6 张精修标准图';
export const SELECTED_STANDARDS_SUBTITLE = '已选标准，作为多视角参考';
export const REFINE_RESULT_MISSING = '请先完成产品精修';
export const MULTIVIEW_RESULT_MISSING = '请先生成产品多视角';
