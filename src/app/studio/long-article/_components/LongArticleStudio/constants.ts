...
export const COPY_ARTICLE_OK = '已复制，可粘贴到平台编辑器';
...
/** 槽位默认比例：默认封面 2.35:1，封面与正文配图统一按它出图。 */
...
/**
 * 距底边线的留白占成图宽的比例：比右边留得多，为常见平台底栏留白，避免与自有水印叠在一起。
 * 按约 677 栏宽实测，底栏干扰区大致在栏宽 4.3% 一带，故这里留 6%——够让开，
