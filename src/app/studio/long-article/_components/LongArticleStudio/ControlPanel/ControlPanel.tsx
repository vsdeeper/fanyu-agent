...
import type { AngleCard, PlanStepSnapshot, StudioPhase, LongArticlePanelValues } from '../types';
import { resolvePlanTitle } from '../utils';
import styles from './ControlPanel.module.css';

type ControlPanelProps = {
  form: FormInstance<LongArticlePanelValues>;
  initialValues: LongArticlePanelValues;
  phase: StudioPhase;
  /** 左栏字段变化；水印图与风格参考图是「改完即落盘」，其余字段等各自步骤的动作统一落盘 */
  onFieldChange: (changed: Partial<LongArticlePanelValues>) => void;
...
/** 长文左栏：按当前步骤展示想法 / 思路参数 / 成稿文风 / 配图水印与风格参考。 */
