...
import type { LongArticleTaskListItem } from '@/app/api/studio/long-article/_shared/task-types';
...
export function createTaskColumns({
  ...
  onMaterial: (task: LongArticleTaskListItem) => void;
  onDelete: (task: LongArticleTaskListItem) => Promise<void>;
}): TableColumnsType<LongArticleTaskListItem> {
  return [
    {
      title: '任务名称',
      dataIndex: 'name',
