...
import type { BusinessAnalysisTaskListItem } from '@/app/api/studio/business-analysis/_shared/task-types';
...
export function createTaskColumns({
  ...
  onMaterial: (task: BusinessAnalysisTaskListItem) => void;
  onDelete: (task: BusinessAnalysisTaskListItem) => Promise<void>;
}): TableColumnsType<BusinessAnalysisTaskListItem> {
  return [
    {
      title: '任务名称',
      dataIndex: 'name',
